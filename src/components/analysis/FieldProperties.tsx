  ...
  return (
    <div className="field-properties">
      <div className="properties-header">
        ...
        <button type="button" onClick={hideProperties} className="properties-close">
          ×
        </button>
      </div>
      ...
      <div className="properties-content">
        ...
        <div className="property-item">
          ...
          <span
            className={`property-value property-status ${selectedField.isValid === false ? 'invalid' : 'valid'}`}
          >
