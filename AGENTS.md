...
- Detalhe: [`.Codex/rules/frontend-standards.md`](rules/frontend-standards.md).
...
- Detalhe: [`.Codex/rules/agent-authority.md`](rules/agent-authority.md).
...
[`.Codex/rules/agent-handoff.md`](rules/agent-handoff.md).

---

## 4. Padrões de Código (React/TS) — resumo

Detalhe completo em [`.Codex/rules/frontend-standards.md`](rules/frontend-standards.md).
...
*LayoutParser React · Codex harness v1 · enxuto, focado em Vite/React/TS*
